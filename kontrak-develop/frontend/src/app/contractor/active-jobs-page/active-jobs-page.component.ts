...
@Component({
  selector: 'app-active-jobs-page',
  templateUrl: './active-jobs-page.component.html',
  styleUrls: ['./active-jobs-page.component.scss']
})
export class ActiveJobsPageComponent implements OnInit {
